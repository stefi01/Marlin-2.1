 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       650        // (mA) RMS current. Multiply by 1.414 for peak current.                            WAS 800 
